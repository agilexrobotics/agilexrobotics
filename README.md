...
| ARM_SDK                      | The materials about the robotic arm are here: [SDK](https://github.com/agilexrobotics/pyAgxArm), [ROS packages](https://github.com/agilexrobotics/agx_arm_ros), [URDF files](https://github.com/agilexrobotics/agx_arm_urdf), [simulation content](https://github.com/agilexrobotics/agx_arm_sim). |
